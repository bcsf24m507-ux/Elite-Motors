...
// Available cars (exclude cars with active bookings)
...
<body class="admin-page">
            ...
            <div class="col-lg-9">
                <div class="dashboard-container" style="min-height: 80vh; overflow-y: auto;">
                    ...
                    <div class="stats-grid">
                        ...
                        <a href="cars.php?filter=available" style="text-decoration: none; color: inherit;" title="Click to see available cars">
                            <div class="stat-card" style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#availableCarsModal">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer" style="background: #FFFFFF;">
                    ...
                    <a href="cars.php?filter=available" class="btn btn-primary">
    ...
    <script>
    // Prevent link navigation when clicking the card
    document.querySelectorAll('a[href="cars.php?filter=available"]').forEach(link => {
        link.addEventListener('click', function(e) {
            e.preventDefault();
            const modal = new bootstrap.Modal(document.getElementById('availableCarsModal'));
            modal.show();
        });
    });
    </script>
